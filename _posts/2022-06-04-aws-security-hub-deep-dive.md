...
#### 1.4. Standalone account environment
...
## 2. Hands-on with AWS Security Hub
...
### 2.4. Finding aggregation (cross-account & cross-region)
...
### 2.7. Automated response, remediation, and enrichment actions
...
## 4. More information about Security Hub
