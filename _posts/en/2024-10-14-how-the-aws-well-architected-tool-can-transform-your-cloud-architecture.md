---
layout: post
title: How the AWS Well-Architected Tool Can Transform Your Cloud Architecture (5/5)
...
The AWS Well-Architected Tool (AWS WA Tool) is an `interactive, web-based service that helps you assess your workloads against the six pillars of the AWS Well-Architected Framework`.

It offers a clear view of your architecture's strengths and weaknesses and provides actionable recommendations to help align your systems with AWS best practices.
...
- The next one is `Test and validate changes`. If we have doubts about what it refers to, we can click on the **Information** button.
  - ![8](8.png)

> In case of doubt when answering a question, the answer is NO.
{: .prompt-tip }
...
- **Lens Details**: Provides a summary per pillar, including your responses and areas needing improvement.
  - ![19](19.png)
  - ![20](20.png)
- **Improvement Plan**: Lists best practices to mitigate the address risks.
  - ![21](21.png)
...
As discussed in the previous section, using the tool generates an `Improvement Plan`, listing the best practices you need to address. However...

> it's now up to you to implement those changes.
{: .prompt-warning }
...
Some recommendations about the next steps:
...
Remember that the key to a well-designed cloud is continuous assessment, improvement, and adaptation.

And if you're eager for more, you can find further information in the following AWS resources:

- WS Well-Architected Framework:
